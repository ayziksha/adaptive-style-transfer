...
class PlacesDataset():
    categories_names = \
        ['/a/airfield', '/a/airplane_cabin', '/a/airport_terminal', '/a/alcove', '/a/alley', '/a/amphitheater',
         ...
         '/a/aquarium', '/a/aqueduct', '/a/arcade', '/a/arch', '/a/archaelogical_excavation', '/a/archive', '/a/arena',
         '/a/arena/hockey', '/a/arena/performance', '/a/arena/rodeo', '/a/army_base', '/a/art_gallery', '/a/art_school',
         '/a/art_studio', '/a/artists_loft', '/a/assembly_line', '/a/athletic_field', '/a/athletic_field/outdoor',
         '/a/atrium', '/a/atrium/public', '/a/attic', '/a/auditorium', '/a/auto_factory', '/a/auto_showroom',
         '/b/badlands', '/b/bakery', '/b/bakery/shop', '/b/balcony', '/b/balcony/exterior', '/b/balcony/interior',
         '/b/ball_pit', '/b/ballroom', '/b/bamboo_forest', '/b/bank_vault', '/b/banquet_hall', '/b/bar', '/b/barn',
         '/b/barndoor', '/b/baseball_field', '/b/basement', '/b/basketball_court', '/b/basketball_court/indoor',
         '/b/bathroom', '/b/bazaar', '/b/bazaar/indoor', '/b/bazaar/outdoor', '/b/beach', '/b/beach_house',
         ...
         '/b/booth/indoor', '/b/botanical_garden', '/b/bow_window', '/b/bow_window/indoor', '/b/bowling_alley',
         '/b/boxing_ring', '/b/bridge', '/b/building_facade', '/b/bullring', '/b/burial_chamber', '/b/bus_interior',
         '/b/bus_station', '/b/bus_station/indoor', '/b/butchers_shop', '/b/butte', '/c/cabin', '/c/cabin/outdoor',
         '/c/cafeteria', '/c/campsite', '/c/campus', '/c/canal', '/c/canal/natural', '/c/canal/urban', '/c/candy_store',
         '/c/canyon', '/c/car_interior', '/c/carrousel', '/c/castle', '/c/catacomb', '/c/cemetery', '/c/chalet',
         '/c/chemistry_lab', '/c/childs_room', '/c/church', '/c/church/indoor', '/c/church/outdoor', '/c/classroom',
         ...
         '/c/crosswalk', '/d/dam', '/d/delicatessen', '/d/department_store', '/d/desert', '/d/desert/sand',
         '/d/desert/vegetation', '/d/desert_road', '/d/diner', '/d/diner/outdoor', '/d/dining_hall', '/d/dining_room',
         '/d/discotheque', '/d/doorway', '/d/doorway/outdoor', '/d/dorm_room', '/d/downtown', '/d/dressing_room',
         '/d/driveway', '/d/drugstore', '/e/elevator', '/e/elevator/door', '/e/elevator_lobby', '/e/elevator_shaft',
         '/e/embassy', '/e/engine_room', '/e/entrance_hall', '/e/escalator', '/e/escalator/indoor', '/e/excavation',
         '/f/fabric_store', '/f/farm', '/f/fastfood_restaurant', '/f/field', '/f/field/cultivated', '/f/field/wild',
         '/f/field_road', '/f/fire_escape', '/f/fire_station', '/f/fishpond', '/f/flea_market', '/f/flea_market/indoor',
         '/f/florist_shop', '/f/florist_shop/indoor', '/f/food_court', '/f/football_field', '/f/forest',
         '/f/forest/broadleaf', '/f/forest_path', '/f/forest_road', '/f/formal_garden', '/f/fountain', '/g/galley',
         '/g/garage', '/g/garage/indoor', '/g/garage/outdoor', '/g/gas_station', '/g/gazebo', '/g/gazebo/exterior',
         ...
         '/g/gymnasium', '/g/gymnasium/indoor', '/h/hangar', '/h/hangar/indoor', '/h/hangar/outdoor', '/h/harbor',
         '/h/hardware_store', '/h/hayfield', '/h/heliport', '/h/highway', '/h/home_office', '/h/home_theater',
         '/h/hospital', '/h/hospital_room', '/h/hot_spring', '/h/hotel', '/h/hotel/outdoor', '/h/hotel_room',
         '/h/house', '/h/hunting_lodge', '/h/hunting_lodge/outdoor', '/i/ice_cream_parlor', '/i/ice_floe',
         '/i/ice_shelf', '/i/ice_skating_rink', '/i/ice_skating_rink/indoor', '/i/ice_skating_rink/outdoor',
         '/i/iceberg', '/i/igloo', '/i/industrial_area', '/i/inn', '/i/inn/outdoor', '/i/islet', '/j/jacuzzi',
         '/j/jacuzzi/indoor', '/j/jail_cell', '/j/japanese_garden', '/j/jewelry_shop', '/j/junkyard', '/k/kasbah',
         '/k/kennel', '/k/kennel/outdoor', '/k/kindergarden_classroom', '/k/kitchen', '/l/lagoon', '/l/lake',
         '/l/lake/natural', '/l/landfill', '/l/landing_deck', '/l/laundromat', '/l/lawn', '/l/lecture_room',
         '/l/legislative_chamber', '/l/library', '/l/library/indoor', '/l/library/outdoor', '/l/lighthouse',
         '/l/living_room', '/l/loading_dock', '/l/lobby', '/l/lock_chamber', '/l/locker_room', '/m/mansion',
         '/m/manufactured_home', '/m/market', '/m/market/indoor', '/m/market/outdoor', '/m/marsh',
         '/m/martial_arts_gym', '/m/mausoleum', '/m/medina', '/m/mezzanine', '/m/moat', '/m/moat/water', '/m/mosque',
         '/m/mosque/outdoor', '/m/motel', '/m/mountain', '/m/mountain_path', '/m/mountain_snowy', '/m/movie_theater',
         '/m/movie_theater/indoor', '/m/museum', '/m/museum/indoor', '/m/museum/outdoor', '/m/music_studio',
         ...
         '/p/pagoda', '/p/palace', '/p/pantry', '/p/park', '/p/parking_garage', '/p/parking_garage/indoor',
         ...
         '/s/server_room', '/s/shed', '/s/shoe_shop', '/s/shopfront', '/s/shopping_mall', '/s/shopping_mall/indoor',
         '/s/shower', '/s/ski_resort', '/s/ski_slope', '/s/sky', '/s/skyscraper', '/s/slum', '/s/snowfield',
         '/s/soccer_field', '/s/stable', '/s/stadium', '/s/stadium/baseball', '/s/stadium/football',
         '/s/stadium/soccer', '/s/stage', '/s/stage/indoor', '/s/stage/outdoor', '/s/staircase', '/s/storage_room',
         '/s/street', '/s/subway_station', '/s/subway_station/platform', '/s/supermarket', '/s/sushi_bar', '/s/swamp',
         '/s/swimming_hole', '/s/swimming_pool', '/s/swimming_pool/indoor', '/s/swimming_pool/outdoor', '/s/synagogue',
         ...
         '/t/train_station', '/t/train_station/platform', '/t/tree_farm', '/t/tree_house', '/t/trench', '/t/tundra',
